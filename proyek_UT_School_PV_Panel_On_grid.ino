...
void loop() {
  ...
  myNex.writeStr("sVolt2.txt", Volt2);
  myNex.writeStr("sAmp2.txt", Amp2);
  myNex.writeStr("sPow2.txt", Pow2);
  myNex.writeStr("sFre2.txt", Fre2);
  myNex.writeStr("sEne2.txt", Ene2);
  myNex.writeStr("sPcf2.txt", Pfc2);
  ...
  myNex.writeStr("sVolt2.txt", Volt1);
  myNex.writeStr("sAmp2.txt", Amp1);
  myNex.writeStr("sPow2.txt", Pow1);
  myNex.writeStr("sFre2.txt", Fre1);
  myNex.writeStr("sEne2.txt", Ene1);
  myNex.writeStr("sPcf2.txt", Pfc1);

  //Load
  String Volt3 = String (voltage3);
  String Amp3 = String (current3);
  String Pow3 = String (power3);
  String Fre3 = String (frequency3, 1);
  String Ene3 = String (energy3, 3);
  String Pfc3 = String (pf3);
  myNex.writeStr("sVolt2.txt", Volt3);
  myNex.writeStr("sAmp2.txt", Amp3);
  myNex.writeStr("sPow2.txt", Pow3);
  myNex.writeStr("sFre2.txt", Fre3);
  myNex.writeStr("sEne2.txt", Ene3);
  myNex.writeStr("sPcf2.txt", Pfc3);
  ...
  myNex.writeStr("sCSP.txt", sCSP); 
   ...
   //WIND TURBINE
//  String sVWT = String (vwt);
  String sCWT = String (DCcurrent2);
  myNex.writeStr("sVSP.txt", sVSP);
  myNex.writeStr("sCSP.txt", sCSP); 
  Serial.print(Volt2 + Amp2 + Pow2 + Ene2 + Fre2 + Pfc2 + vsp + DCcurrent1);
